...
public class  User implements UserDetails {
    ...
    private UserRole role; //Usando um ENUM
    private String cpf;
    private String nome;
    ...
    @Override
    public Collection<? extends GrantedAuthority> getAuthorities() { //Aqui se verifica as ROLES que determinado usuário possui
